...
@section('content')
    ...
    @if(Gate::forUser(auth()->user())->check('admin.permission.create'))
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_edit = {{Gate::forUser(auth()->user())->check('admin.permission.edit') ? 1 : 0}};
                            var row_delete = {{Gate::forUser(auth()->user())->check('admin.permission.destroy') ? 1 :0}};
                            var str = '';
