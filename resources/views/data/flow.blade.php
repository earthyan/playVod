...
@section('content')
    ...
    <div class="show-con">
        <div class="date-con">
            ...
            <div id="btn1" class="date-btn2" onclick="timeChange('today',1)">今天</div>
            <div id="btn2" class="date-btn" onclick="timeChange('yesterday',2)">昨天</div>
            <div id="btn3" class="date-btn" onclick="timeChange('week',3)">7天</div>
            <div id="btn4" class="date-btn" onclick="timeChange('month',4)">30天</div>
        </div>
